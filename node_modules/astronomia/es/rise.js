...
var D2R = Math.PI / 180;
export var errorAboveHorizon = base.errorCode('always above horizon', -1);
export var errorBelowHorizon = base.errorCode('always below horizon', 1);
/**
 * mean refraction of the atmosphere
 */

export var meanRefraction = new sexa.Angle(false, 0, 34, 0).rad();
/**
...
export var stdh0Stellar = function stdh0Stellar(_refraction) {
  return refraction(stdh0.stellar, _refraction);
};
export var Stdh0Stellar = stdh0Stellar(); // for backward-compatibility

/**
 * standard altitude for sun for upper limb of the disk
 */

export var stdh0Solar = function stdh0Solar(_refraction) {
  return refraction(stdh0.solar, _refraction);
};
export var Stdh0Solar = stdh0Solar(); // for backward-compatibility

/**
 * standard altitude for moon (low accuracy)
 */

export var stdh0LunarMean = function stdh0LunarMean(_refraction) {
  return stdh0.lunarMean - refraction(_refraction);
};
export var Stdh0LunarMean = stdh0LunarMean(); // for backward-compatibility
...
export var stdh0Lunar = function stdh0Lunar(π, refraction) {
  refraction = refraction || meanRefraction;
  return stdh0.lunar * π - refraction;
};
export var Stdh0Lunar = stdh0Lunar; // for backward-compatibility
...
export { _approxTimes as approxTimes };
...
function _times(p, ΔT, h0, Th0, α3, δ3) {
  ...
  var d3δ = new interp.Len3(-SECS_PER_DAY, SECS_PER_DAY, δ3); // adjust mTransit
...
function () {
  ...
  var _proto = PlanetRise.prototype;

  _proto.approxTimes = function approxTimes() {
  ...
  _proto._toArr = function _toArr(body, p) {
  ...
  _proto._rsToJD = function _rsToJD(rs) {
    return {
  ...
  _proto._toJD = function _toJD(secs) {
