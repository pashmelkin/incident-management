...
function horizontal(Δ) {
  // (40.1) p. 279
  return Math.asin(Math.sin(horPar) / Δ); // return horPar / Δ // with sufficient accuracy
}
/**
...
function topocentric(c, ρsφ, ρcφ, lon, jde) {
  var _ref = [c.ra, c.dec, c.range],
      ...
      Δ = _ref[2];
  var π = horizontal(Δ);
  var θ0 = new _sexagesimal["default"].Time(_sidereal["default"].apparent(jde)).rad();

  var H = _base["default"].pmod(θ0 - lon - α, 2 * Math.PI);

  var sπ = Math.sin(π);

  var _base$sincos = _base["default"].sincos(H),
      _base$sincos2 = _slicedToArray(_base$sincos, 2),
      sH = _base$sincos2[0],
      cH = _base$sincos2[1];

  var _base$sincos3 = _base["default"].sincos(δ),
  ...
  return new _base["default"].Coord(α_, δ_);
}
/**
...
function topocentric2(c, ρsφ, ρcφ, lon, jde) {
  ...
  var _base$sincos5 = _base["default"].sincos(H),
      _base$sincos6 = _slicedToArray(_base$sincos5, 2),
      sH = _base$sincos6[0],
      cH = _base$sincos6[1];

  var _base$sincos7 = _base["default"].sincos(δ),
  ...
  return new _base["default"].Coord(Δα, Δδ);
}
/**
...
function topocentric3(c, ρsφ_, ρcφ_, lon, jde) {
  ...
  var _base$sincos11 = _base["default"].sincos(δ),
