...
exports["default"] = exports.selenographic = exports.Moon = void 0;
...
var _base$sincos = _base["default"].sincos(_I),
...
function physical(jde, earth) {
  var _moonposition$positio = _moonposition["default"].position(jde),
  ...
  var cMoon = new _base["default"].Coord(l, b);
  var cSun = new _base["default"].Coord(l0, b0);
  return [cMoon, P, cSun];
}
/**
...
function () {
  function Moon(jde) {
    ...
    var F = this.F = _base["default"].horner(T, 93.272095 * D2R, 483202.0175233 * D2R, -0.0036539 * D2R, -D2R / 3526000, D2R / 863310000);

    this.Ω = _base["default"].horner(T, 125.0445479 * D2R, -1934.1362891 * D2R, 0.0020754 * D2R, D2R / 467441, -D2R / 60616000); // true ecliptic

    this.ε = _nutation["default"].meanObliquity(jde) + Δε;
    this.sε = sin(this.ε);
    this.cε = cos(this.ε); // ρ, σ, τ, p. 372,373
  ...
  _createClass(Moon, [{
    ...
    value: function lib(λ, β) {
      var _this$optical = this.optical(λ, β),
          _this$optical2 = _slicedToArray(_this$optical, 3),
          l_ = _this$optical2[0],
          b_ = _this$optical2[1],
          A = _this$optical2[2];

      var _this$physical = this.physical(A, b_),
          _this$physical2 = _slicedToArray(_this$physical, 2),
          l$ = _this$physical2[0],
          b$ = _this$physical2[1];
    ...
    value: function optical(λ, β) {
      ...
      var l_ = _base["default"].pmod(A - this.F, 2 * Math.PI);
    ...
    value: function physical(A, b_) {
      // (53.2) p. 373
      var _base$sincos7 = _base["default"].sincos(A),
    ...
    value: function pa(λ, β, b) {
      ...
      var _base$sincos9 = _base["default"].sincos(V),
          _base$sincos10 = _slicedToArray(_base$sincos9, 2),
          sV = _base$sincos10[0],
          cV = _base$sincos10[1];

      var _base$sincos11 = _base["default"].sincos(_I + this.ρ),
      ...
      var ecl = new _coord["default"].Ecliptic(λ + this.Δψ, β).toEquatorial(this.ε); // eslint-disable-line no-unused-vars
...
function sunAltitude(cOnMoon, cSun) {
  ...
  var _base$sincos13 = _base["default"].sincos(cSun.lat),
      _base$sincos14 = _slicedToArray(_base$sincos13, 2),
      sb0 = _base$sincos14[0],
      cb0 = _base$sincos14[1];

  var _base$sincos15 = _base["default"].sincos(cOnMoon.lat),
...
var lunarCoord = function lunarCoord(η, θ) {
  return new _base["default"].Coord(η * D2R, θ * D2R);
};
/**
