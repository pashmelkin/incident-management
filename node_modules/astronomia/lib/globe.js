...
exports["default"] = exports.Coord = exports.RotationRate1996_5 = exports.Earth76 = exports.Ellipsoid = void 0;
...
function () {
  ...
  _createClass(Ellipsoid, [{
    ...
    value: function parallaxConstants(φ, h) {
      ...
      var s = Math.sin(φ);
      var c = Math.cos(φ);
      var hoa = h * 1e-3 / this.radius; // (s, c float)
...
var RotationRate1996_5 = 7.292114992e-5; // eslint-disable-line camelcase
...
var _default = {
  Ellipsoid: Ellipsoid,
  Earth76: Earth76,
  RotationRate1996_5: RotationRate1996_5,
  oneDegreeOfLongitude: oneDegreeOfLongitude,
  oneDegreeOfLatitude: oneDegreeOfLatitude,
  geocentricLatitudeDifference: geocentricLatitudeDifference,
  Coord: Coord,
  approxAngularDistance: approxAngularDistance,
  approxLinearDistance: approxLinearDistance
};
