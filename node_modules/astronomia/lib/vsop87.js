...
exports["default"] = exports.VSOP = void 0;
...
var REGVSOP = /^\sVSOP87.*VARIABLE (\d) \((LBR|XYZ)\).{1,20}\*T\*\*(\d)\s{1,20}(\d{1,20}) TERMS/; // planet names in VSOP87 files

var planets = ['mercury', 'venus', 'earth', 'mars', 'jupiter', 'saturn', 'uranus', 'neptune']; // VSOP planet extension names
...
function () {
  ...
  _createClass(VSOP, [{
    ...
    value: function load(cb) {
      ...
      var filename = _path["default"].resolve(this.dirname, 'VSOP87' + this.type + '.' + ext);
