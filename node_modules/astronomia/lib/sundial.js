...
function general(φ, D, a, z) {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    for (var _i2 = 0, _m = m; _i2 < _m.length; _i2++) {
      var d = _m[_i2];
...
function equatorial(φ, a) {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    for (var _i3 = 0, _m2 = m; _i3 < _m2.length; _i3++) {
      var d = _m2[_i3];
      var tδ = Math.tan(d * Math.PI / 180);
      var H0 = Math.acos(-tφ * tδ);
...
function horizontal(φ, a) {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    for (var _i4 = 0, _m3 = m; _i4 < _m3.length; _i4++) {
      var d = _m3[_i4];
      var tδ = Math.tan(d * Math.PI / 180);
      var H0 = Math.acos(-tφ * tδ);
...
function vertical(φ, D, a) {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    for (var _i5 = 0, _m4 = m; _i5 < _m4.length; _i5++) {
      var d = _m4[_i5];
      var tδ = Math.tan(d * Math.PI / 180);
      var H0 = Math.acos(-tφ * tδ);
