...
exports["default"] = exports.iau82 = void 0;
...
function JDToCFrac(jd) {
  var _base$modf = _base["default"].modf(jd + 0.5),
      _base$modf2 = _slicedToArray(_base$modf, 2),
      j0 = _base$modf2[0],
      f = _base$modf2[1];

  return [_base["default"].J2000Century(j0 - 0.5), f]; // (cen, dayFrac /* float */)
}
/**
...
var iau82 = [24110.54841, 8640184.812866, 0.093104, -0.0000062];
/**
...
function mean(jd) {
  return _base["default"].pmod(_mean(jd), 86400);
}
/**
 * @private
 */
...
/* float */
  ...
  return _base["default"].pmod(s, 86400);
}
/**
 * @private
 */
...
/* float */
  ...
  var _JDToCFrac = JDToCFrac(jd),
      ...
      cen = _JDToCFrac2[0],
      f = _JDToCFrac2[1]; // (12.2) p. 87


  return [_base["default"].horner.apply(_base["default"], [cen].concat(iau82)), f]; // (sidereal, dayFrac /* float */)
}
/**
...
function apparent(jd) {
  ...
  var n = _nutation["default"].nutationInRA(jd); // angle (radians) of RA


  var ns = n * 3600 * 180 / Math.PI / 15; // convert RA to time in seconds

  return _base["default"].pmod(s + ns, 86400);
}
/**
...
function apparent0UT(jd) {
  var _base$modf3 = _base["default"].modf(jd + 0.5),
      _base$modf4 = _slicedToArray(_base$modf3, 2),
      j0 = _base$modf4[0],
      f = _base$modf4[1];

  var cen = (j0 - 0.5 - _base["default"].J2000) / 36525;
  var s = _base["default"].horner.apply(_base["default"], [cen].concat(iau82)) + f * 1.00273790935 * 86400;

  var n = _nutation["default"].nutationInRA(j0); // angle (radians) of RA
